...
class ItunesBrowserDebugSpider(scrapy.Spider):
    name = "itune_browser_debug"
    ...
    def __init__(self, name=None, **kwargs):
        ...
        super(ItunesBrowserDebugSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(ItunesBrowserDebugSpider, cls).from_crawler(crawler,
                                                                 args,
