from cwemail.parser.browse_parser import BrowseParser
...
class DatabaseFactory:
    ...
    @staticmethod
    def get_database(dbType, uri, db="vps_scrapy_rails", collection="emails"):

        from cwemail.database.cache_db import CacheDatabase
        from cwemail.database.history_db import HistoryDatabase
        from cwemail.database.item_db import ItemDatabase
