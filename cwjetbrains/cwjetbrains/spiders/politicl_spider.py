...
from cwjetbrains.items import HistoryItem


class JetBrainssSpider(scrapy.Spider):
    name = "jetbrains"
    ...
    def __init__(self, name=None, **kwargs):
        ...
        from cwjetbrains.spiders.dispatch.spider_dispatch import SpiderDispatch
        ...
        super(JetBrainssSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(JetBrainssSpider, cls).from_crawler(crawler,
                                                        args,
