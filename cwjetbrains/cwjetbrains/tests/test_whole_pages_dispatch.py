...
from cwjetbrains.scraped_websites import WebsiteTypes
from cwjetbrains.spiders.dispatch.spider_whole_pages_dispatch import WholePagesStatus
...
class WholePagesDispatchTest(unittest.TestCase):
    def setUp(self):
        ...
        self.dict = {
            WebsiteTypes.webstorm.value: 'http://www.dailyo.in/politics?page={}',
