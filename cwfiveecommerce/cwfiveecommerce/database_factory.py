...
class DatabaseFactory(object):
    ...
    def get_database(self, collection_type):
        if CollectionTypes.cache == collection_type:
            from cwfiveecommerce.database.cache_db import CacheDatabase
            ...
            from cwfiveecommerce.database.history_db import HistoryDatabase
            ...
            from cwfiveecommerce.database.page_db import PageDatabase
            ...
            from cwfiveecommerce.database.item_db import ItemDatabase
