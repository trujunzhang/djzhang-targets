...
from cwfiveecommerce.items import HistoryItem


class FiveeCommercesSpider(scrapy.Spider):
    name = "fiveecommerce"
    ...
    def __init__(self, name=None, **kwargs):
        ...
        super(FiveeCommercesSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(FiveeCommercesSpider, cls).from_crawler(crawler,
                                                        args,
