...
class FiveeCommercesWatchSpider(scrapy.Spider):
    name = "fiveecommerce_whole_pages"
    ...
    def __init__(self, name=None, **kwargs):
        ...
        from cwfiveecommerce.spiders.dispatch.spider_whole_pages_dispatch import SpiderWholePageDispatch
        ...
        super(FiveeCommercesWatchSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(FiveeCommercesWatchSpider, cls).from_crawler(crawler,
                                                             args,
