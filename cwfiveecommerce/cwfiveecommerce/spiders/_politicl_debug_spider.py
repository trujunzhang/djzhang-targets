...
from cwfiveecommerce.htmls.detail_pages import scraped_detail_pages
from cwfiveecommerce.scraped_websites import WebsiteTypes, websites_allowed_domains, websites_parses, is_pagination, \
    get_crawler_name


class FiveeCommerceDebugSpider(scrapy.Spider):
    url_from = get_crawler_name()['url_from']
    name = "fiveecommerce_debug"
    ...
    def __init__(self, name=None, **kwargs):
        ...
        from cwfiveecommerce.extensions.rpc.wordpress_xml_rpc_utils import WDXmlRPCUtils
        self.wd_rpc = WDXmlRPCUtils(kwargs['wd_host'], kwargs['wd_user'], kwargs['wd_passwd'])

        self._parser = websites_parses.get(self.url_from)

        super(FiveeCommerceDebugSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(FiveeCommerceDebugSpider, cls).from_crawler(crawler,
                                                            args,
