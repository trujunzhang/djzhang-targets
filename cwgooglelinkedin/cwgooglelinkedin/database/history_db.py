from cwgooglelinkedin.database.base_db import BaseDatabase

import logging
from datetime import datetime

from cwgooglelinkedin.utils.crawl_utils import CrawlUtils
...
class HistoryDatabase(BaseDatabase):
    ...
    def process_item(self, url, item=None):
        ...
        logging.debug("GoogleLinkedInHistory added to MongoDB database!")
