from cwgooglelinkedin.parser.browse_parser import BrowseParser
...
class DatabaseFactory:
    ...
    @staticmethod
    def get_database(dbType, uri, db="vps_scrapy_rails", collection="googlelinkedins"):

        from cwgooglelinkedin.database.cache_db import CacheDatabase
        from cwgooglelinkedin.database.history_db import HistoryDatabase
        from cwgooglelinkedin.database.item_db import ItemDatabase
