from cwaliexpress.database.base_db import BaseDatabase

import logging
from scrapy.exceptions import DropItem
from datetime import datetime

from cwaliexpress.utils.crawl_utils import CrawlUtils
...
class ItemDatabase(BaseDatabase):
    ...
    def process_item(self, url, item=None):
        ...
        if valid:
            ...
            logging.debug("AliExpress added to MongoDB database!")
