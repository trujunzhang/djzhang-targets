...
class HindustantimesDebugSpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        super(HindustantimesDebugSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(HindustantimesDebugSpider, cls).from_crawler(crawler,
                                                                  args,
