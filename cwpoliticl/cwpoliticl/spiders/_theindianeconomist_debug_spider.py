...
class TheIndianEconomistDebugSpider(scrapy.Spider):
    url_from = WebsiteTypes.theindianeconomist
    name = "{}_debug".format(url_from.value)
    details_urls = [
        # Detail
        'http://theindianeconomist.com/plantation-drive-akhilesh-government-5-crore-saplings-planted/'
    ]
    ...
    def __init__(self, name=None, **kwargs):
        ...
        super(TheIndianEconomistDebugSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(TheIndianEconomistDebugSpider, cls).from_crawler(crawler,
                                                                      args,
