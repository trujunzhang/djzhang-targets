...
class News18DebugSpider(scrapy.Spider):
    url_from = WebsiteTypes.news18
    name = "{}_debug".format(url_from.value)
    details_urls = [
        # Detail
        'http://www.news18.com/blogs/politics/ayushman-jamwal/gandhi-the-name-wont-seal-victory-11302-1267726.html'
    ]
    ...
    def __init__(self, name=None, **kwargs):
        ...
        super(News18DebugSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(News18DebugSpider, cls).from_crawler(crawler,
                                                          args,
