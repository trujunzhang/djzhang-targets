...
class DeccanchronicleDebugSpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        super(DeccanchronicleDebugSpider, self).__init__(name, **kwargs)

    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        return super(DeccanchronicleDebugSpider, cls).from_crawler(crawler,
                                                                   args,
